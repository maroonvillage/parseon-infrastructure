...
//TODO: add github_oidc_subjects for both backend and frontend modules to further restrict the OIDC trust policy to only allow tokens from specific repos/environments. For now, the trust policy allows any sub claim from the configured repository, so use with caution.
backend_github_oidc_subjects = [
  "repo:your-org/your-backend-repo:environment:dev"
]

frontend_github_oidc_subjects = [
  "repo:your-org/your-frontend-repo:environment:dev"
]
